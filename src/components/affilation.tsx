      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="max-w-3xl mb-16">
          ...
          <p className="text-slate-600 text-lg leading-relaxed">
            ...
            Aptech students gain access to globally recognized degrees and career pathways
            across the UK, UAE, Canada, Malaysia, and beyond.
          </p>
        </div>
            ...
            {[...logos, ...logos].map((logo: Logo, index: number) => (
              ...
              >
                <img
                  src={logo}
                  alt="partner logo"
                  className="h-16 object-contain opacity-60 hover:opacity-100 hover:scale-110 transition duration-300"
                />
              </div>
            ))}
          </motion.div>
